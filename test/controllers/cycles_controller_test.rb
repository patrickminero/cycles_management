...
class CyclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cycle" do
    assert_difference('Cycle.count') do
      post cycles_url, params: { cycle: { components: @cycle.components, name: @cycle.name } }
    end
  ...
  test "should update cycle" do
    patch cycle_url(@cycle), params: { cycle: { components: @cycle.components, name: @cycle.name } }
